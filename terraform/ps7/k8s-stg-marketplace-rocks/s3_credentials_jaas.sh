...
AWS_ACCESS_KEY_ID=$(vault kv get -field=access_key secret/services/k8s-stg-marketplace-rocks/s3) || return 0
AWS_SECRET_ACCESS_KEY=$(vault kv get -field=secret_key secret/services/k8s-stg-marketplace-rocks/s3) || return 0
export AWS_ACCESS_KEY_ID
export AWS_SECRET_ACCESS_KEY
echo "Backend credentials set for k8s-stg-marketplace-rocks in cloud ps7"
